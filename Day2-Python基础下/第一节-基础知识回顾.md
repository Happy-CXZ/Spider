...
通常情况下, 目前计划每周两节课 晚上8点上课.  但是为了课程完整性, 以及一些特殊情况. 会有调整. **各位一定要注意群公告**. 有些人习惯性把群屏蔽.  请把"樵夫"设置为**关注的群成员**.  这样避免遗漏掉最新的通知. 



关于答疑, 写程序嘛, 出问题很正常, 不要慌. 先阅读错误信息.  找到错误信息中的关键点. 第一个, 是最后一句错误信息, 第二个,  找你写的代码的第几行..... 是行号. 



最后一句错误信息一般都会很直接的告诉你. 出了什么问题. 而行号, 能告诉你, 哪里出问题了. 再去结合你写的代码. 去感觉, 去猜测, 哪里会出问题. **慢慢的培养自己解决问题的能力. 这个很重要.** 
...
如果你截图截的是代码。 那么请带上行号。 截图的信息. 越全越好.

问问题的时候. 尽量的把问题描述清楚... 



樵夫哭着诉求。 尽量不要用手机拍照了。  电脑上装个微信.  alt+a就可以截图了. 很简单...

或者装一个Snipaste, 专业的截图工具. 
...
https://www.apecome.com/series/XL100098xxxxxx

至少学到03-04位置"函数的返回值". 然后就可以看爬虫了. 



没基础. 直播跟不上. 切忌不要硬跟直播(懵). 不如慢慢看录播.   5年内随便重修....
